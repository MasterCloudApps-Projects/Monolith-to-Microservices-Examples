...
public class PayrollService {
  ...
  private FF4j ff4j;
  private DiferenciaService diferenciaService;
  ...
  public PayrollService(
      ...
      FF4j ff4j,
      DiferenciaService diferenciaService) {
    this.userNotificationService = userNotificationService;
    this.userNotificationServiceMS = userNotificationServiceMS;
    this.ff4j = ff4j;
    this.diferenciaService = diferenciaService;
  ...
  public void savePayroll(Payroll payroll) throws IOException {
    ...
    userNotificationService.notify(String.format("Payroll %s shipped to %s of %s", payroll.getId(), payroll.getShipTo(),
          payroll.getTotal()));
    diferenciaService.diferenciaCore(payroll.getId());
  }
