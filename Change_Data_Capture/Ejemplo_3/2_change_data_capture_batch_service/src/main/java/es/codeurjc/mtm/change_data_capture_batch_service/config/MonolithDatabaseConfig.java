package es.codeurjc.mtm.change_data_capture_batch_service.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "monolithEntityManagerFactory", transactionManagerRef = "monolithTransactionManager", basePackages = {
    "es.codeurjc.mtm.change_data_capture_batch_service.repository.mono"})
...
public class MonolithDatabaseConfig {
  ...
  public LocalContainerEntityManagerFactoryBean monolithEntityManagerFactory() {
    ...
    em.setPackagesToScan("es.codeurjc.mtm.change_data_capture_batch_service.model");
